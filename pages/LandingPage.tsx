        ...
        <div className="min-h-screen bg-[#0b1527] text-white font-sans selection:bg-scholafy-accent selection:text-scholafy-panel overflow-x-hidden scroll-smooth">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0b1527]/90 backdrop-blur-lg border-b border-white/5 shadow-2xl transition-all duration-300">
                <div className="max-w-7xl mx-auto px-4 md:px-6 h-16 md:h-20 flex items-center justify-between">
                    ...
                    <Link
                        to="/select-profile"
                        className="animate-in slide-in-from-top-2 duration-1000 bg-white/10 hover:bg-white/20 border border-white/10 px-4 md:px-6 py-1.5 md:py-2 rounded-full text-sm md:text-base font-semibold transition-all hover:scale-105 active:scale-95 shadow-lg flex items-center justify-center"
                    >
                        Login
                    </Link>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8 flex flex-col hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <button onClick={() => navigate('/select-profile')} className="w-full py-3 rounded-lg border border-white/20 hover:bg-white/10 transition-colors font-bold">Start Trial</button>
                        </div>
                        ...
                        <div className="bg-scholafy-card border border-scholafy-accent rounded-2xl p-6 md:p-8 flex flex-col transform md:-translate-y-4 shadow-[0_0_50px_rgba(243,197,0,0.1)] relative hover:-translate-y-6 transition-transform duration-300">
                            ...
                            <button onClick={() => navigate('/select-profile')} className="w-full py-3 rounded-lg bg-scholafy-accent text-scholafy-panel hover:bg-yellow-400 transition-colors font-bold shadow-lg">Get Started</button>
                        </div>
